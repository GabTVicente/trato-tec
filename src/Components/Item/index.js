...
export default function Item(props) {
  ...
  const inCart = useSelector(state => state.carrinho.some(itemNoCarrinho => itemNoCarrinho.id === id));
        ...
        <div className={styles['item-info']}>
          ...
          <div className={styles['item-acoes']}>
            {favorito
              ...
              : <AiOutlineHeart onClick={resolverFavorito} {...iconeProps} />
            }
            {
              carrinho
                ? (
                ...
                : (<FaCartPlus
                  {...iconeProps}
                  color={inCart ? '#1875e9' : iconeProps.color}
